...
HD_PWD='C:/Users/ASUS/Desktop/FPGA/DialogSemi/DialogSemi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_synth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_synth.tcl
