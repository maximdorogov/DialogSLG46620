...
HD_PWD='C:/Users/ASUS/Desktop/FPGA/DialogSemi/DialogSemi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_synth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_synth.tcl -notrace
